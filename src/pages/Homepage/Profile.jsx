        ...
        <div class="max-w-2xl px-4 py-8 mx-auto lg:py-16">
          <form action="#">
            ...
            <div class="flex mb-5 -space-x-3">
              <img
                class="w-12 h-12 rounded-full ring-2 ring-gray-300 dark:ring-gray-100"
                src="https://pbs.twimg.com/media/EwtHu9PVEAcetn3.jpg"
                alt="Bordered avatar"
              />
              <img
                class="w-12 h-12 rounded-full ring-2 ring-gray-300 dark:ring-gray-100"
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQn7n_hjrfOEgfm7CTRjgTURpIw1IN0Yp4pBQ&usqp=CAU"
                alt="Bordered avatar"
              />
              <img
                class="w-12 h-12 rounded-full ring-2 ring-gray-300 dark:ring-gray-100"
              ...
              <img
                class="w-12 h-12 rounded-full ring-2 ring-gray-300 dark:ring-gray-100"
                src="https://preview.redd.it/rtxckdqn4qk71.jpg?width=640&crop=smart&auto=webp&s=361061df2f2be4434d317141dfcecd7805cf7a88"
                alt="Bordered avatar"
              />
            </div>
          </form>
